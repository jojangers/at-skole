...
%%%%%%%%%
% Sáttmála variablar
\def \Kunden		{Landssjúkrahúsið}
\def \KundenPf		{ }
\def \KundenAddr	{J.C. Svabosgøta 41-49}
\def \KundenPost	{FO-100 Tórshavn}
\def \KundenVTAL	{345334}
\def \KundenKontakt	{Annfinn Thomsen}
\def \KundenUnderskriftsLokation	{LSH}

\def \SynackUnderskriftsLokation	{LSH}
\def \SynackUnderskriver			{Heðin Ejdesgaard Møller}

\def \dato				{1. Februar 2016}
\def \datoBindingA		{31. Juli 2016}
...
\def \timeRabat		{0.65} 		% 1-0.procentsats
\begin{document}
\begin{titlepage}
	\vspace*{-20mm} \large
	\begin{tikzpicture} 
...
\begin{center}
	\addcontentsline{toc}{section} {§3 Tagnarskilda og ognarrættur}
...
\begin{center}
	\addcontentsline{toc}{section} {§6 Lisensir og broytingar}
