...
\def \ambProxmox		{1 }	% Hvor mange proxmox servere skal vi passe?
\def \ambWindows		{1 }	% Hvor mange windows servere skal vi passe?
\def \ambCloud			{1 }	% Hvor mange windows servere skal vi passe?

\def \backupSize		{100}	% GB size
\def \backupPris		{4}		% kr/GB
